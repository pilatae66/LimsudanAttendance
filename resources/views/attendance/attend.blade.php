			...
			<div class="content">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
                            @csrf
                            <div class="card card-login card-hidden" style="margin:0; padding:0 ">
                                                        ...
                                                        <div class="col-md-4" style="padding:10px">
                                                            <div class="pull-right">
                                                                <div style="height:200px; width:200px; padding:5px; border:solid 2px gray; border-radius:100px;">
                                                                    ...
                                                                    <img src="{{ asset('storage/upload/'.$employee->fileName) }}" alt="User Photo" style="border-radius: 100px">
                        ...
                        <form method="POST" action="{{ route('employee.attend') }}">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group label-floating{{ $errors->has('id') ? ' has-error' : '' }}">
                                    ...
                                    <input type="hidden" name="type" value="Time In">
                        ...
                        <form method="POST" action="{{ route('employee.attend') }}">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group label-floating{{ $errors->has('id') ? ' has-error' : '' }}">
                                    ...
                                    <input name="id" id="id" type="text" class="form-control" autofocus> 
                                    <input type="hidden" name="type" value="Time Out">
                                    <span class="material-icons form-control-feedback">clear</span>
                                    @if ($errors->has('id'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('id') }}</strong>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(window).keypress(function (event) {
                if (event.which === 49 && !$('#timeInModal').hasClass('in') && !$('#timeOutModal').hasClass('in')) {
                    console.log($('#timeInModal').hasClass('in'))
                    $('#timeInButton').click()
                    $('#timeInModal :text').val('')
                }
                else if (event.which === 50 && !$('#timeInModal').hasClass('in') && !$('#timeOutModal').hasClass('in')) {
                    console.log($('#timeOutModal').hasClass('in'))
                    $('#timeOutButton').click()
